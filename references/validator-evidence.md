...
(`0`), `fail` (`2`), and `not_assessed` (`3`). A Pass establishes independent
strict-inspection evidence for this candidate only. Review every profile and
error before attributing a Fail to the artifact, and complete the remaining
